...
```
The rationale may be generated using [MEDprompt's](https://github.com/dermatologist/medprompt) [Self Generated COT Chain](https://github.com/dermatologist/medprompt/blob/develop/src/medprompt/chains/self_gen_cot_chain.py).
